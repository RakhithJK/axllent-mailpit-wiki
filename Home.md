# Mailpit - an email testing tool for developers
...
- [SMTP relay / releasing] - (https://github.com/axllent/mailpit/wiki/SMTP-relay) - allow Mailpit to pass on messages to a different SMTP server
